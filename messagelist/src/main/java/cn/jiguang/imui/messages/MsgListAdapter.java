...
public class MsgListAdapter<MESSAGE extends IMessage> extends RecyclerView.Adapter<ViewHolder>
    ...
    /**
     * Set long click listener for item_contact_list, fires only if selection mode is disabled.
     *
    ...
    /**
     * Callback will invoked when message item_contact_list is clicked
     *
     * @param <MESSAGE>
     */
    ...
    /**
     * Callback will invoked when message item_contact_list is long clicked
     *
     * @param <MESSAGE>
     */
