...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = BaseApplication.Companion.getContext().getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = BaseApplication.Companion.getContext().getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
