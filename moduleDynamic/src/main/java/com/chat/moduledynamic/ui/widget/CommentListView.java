...
public class CommentListView extends LinearLayout {
    ...
    private List<DynamicCommentData> mDatas;
    ...
    public void setDatas(List<DynamicCommentData> datas) {
        if (datas == null) {
            datas = new ArrayList<DynamicCommentData>();
        }
        mDatas = datas;
        notifyDataSetChanged();
    }

    public List<DynamicCommentData> getDatas() {
        return mDatas;
    }
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mDatas.size(); i++) {
            ...
            if (view == null) {
                throw new NullPointerException("listview item_contact_list layout is null, please check getView()...");
            }
    ...
    private View getView(final int position) {
        ...
        final DynamicCommentData bean = mDatas.get(position);
        String name = bean.getFrom_friend_remark();
        int id = bean.getComment_id();
        String toReplyName = "";
        if (bean.getTo_user_id() > 0) {
            toReplyName = bean.getTo_friend_remark();
        }

        SpannableStringBuilder builder = new SpannableStringBuilder();
        builder.append(setClickableSpan(name, String.valueOf(bean.getFrom_user_id())));

        if (!TextUtils.isEmpty(toReplyName)) {
            builder.append(" 回复 ");
            builder.append(setClickableSpan(toReplyName, String.valueOf(bean.getTo_user_id())));
        }
        builder.append(": ");
        //转换表情字符
        ...
        subjectSpanText.setSpan(new SpannableClickable(itemColor) {
                                    ...
                                    public void onClick(View widget) {
                                        ARouter
                                                ...
                                                .withInt("USER_ID", Integer.parseInt(id))
                                                .navigation();
                                    }
