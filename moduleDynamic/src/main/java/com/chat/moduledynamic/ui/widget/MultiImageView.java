...
public class MultiImageView extends LinearLayout {
    ...
    private void initImageLayoutParams() {
        ...
        onePicPara = new LayoutParams(wrap, DensityUtil.dip2px(getContext(), 120));
...
//            int expectH = photoInfo.h;
        ...
        imageView.setBackgroundColor(getResources().getColor(R.color.default_clickable_color));
//		Glide.with(getContext()).load(photoInfo.url).diskCacheStrategy(DiskCacheStrategy.ALL).into(imageView);
        ImageUtil.INSTANCE.loadOriginalImage(getContext(), photoInfo, imageView, R.color.color_f9f9f9);
        return imageView;
    }
