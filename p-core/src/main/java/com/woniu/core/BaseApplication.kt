...
import com.woniu.core.dao.DaoMaster
import com.woniu.core.dao.DaoSession
import com.woniu.core.router.RouterConfig
...
open class BaseApplication : MultiDexApplication() {
    ...
    private fun initEasyHttp(){
        ...
        EasyHttp.getInstance()
            ...
            //可以全局统一设置全局URL
            .setBaseUrl(Config.API.base_url)//设置全局URL  url只能是域名 或者域名+端口号
...
//            .addInterceptor(new CustomSignInterceptor());//添加参数签名拦截器
    ...
    private fun initGreenDao(){
        var openHeler: DaoMaster.DevOpenHelper = DaoMaster.DevOpenHelper(this,Config.DBTable.DB_BASE_NAME)

        mDaoSession = DaoMaster(openHeler.writableDb).newSession()
    }
