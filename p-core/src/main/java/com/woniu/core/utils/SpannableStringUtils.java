...
public class SpannableStringUtils {
     ...
     * @return the single {@link SpannableStringUtils} instance
     */
    public SpannableStringUtils setAlign(@NonNull final Layout.Alignment alignment) {
    ...
    public SpannableStringUtils appendImage(@DrawableRes final int resourceId, @Align final int align,int width,int height) {
        apply(mTypeImage);
        this.imageResourceId = resourceId;
        this.alignImage = align;
    ...
    public SpannableStringUtils appendImage(@NonNull final Bitmap bitmap,@Align final int align,int width,int height) {
        this.imageWidth = width;
        this.imageHeight = height;
        return appendImage(bitmap, align);
    }
